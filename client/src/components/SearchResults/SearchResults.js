    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative w-full h-[450px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 px-4">
          <h2 className="text-4xl md:text-6xl mt-60 font-medium text-white text-center">Live Singers In Chandigarh</h2>
          <p className="text-white text-lg mt-4 text-center">Your subtitle text here</p>
        </div>
      </div>
