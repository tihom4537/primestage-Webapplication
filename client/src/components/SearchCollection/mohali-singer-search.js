...
const MohaliSingerSearchResults = () => {
 ...
 useEffect(() => {
  ...
  // Update document title and meta tags
    document.title = "Live Singers In Mohali";
    ...
    updateMetaTag('og:title', 'Live Singers In Mohali', true);
    updateMetaTag('og:description', 'Hire the best live singer in Mohali directly with no middleman. PrimeStage offers top-rated singers for weddings, parties, and live events.', true);
    updateMetaTag('og:image', '/og-image.jpg', true);


    // Twitter Cards
   updateMetaTag('twitter:card', 'summary_large_image', true);
   updateMetaTag('twitter:title', 'Live Singers In Mohali', true);
   updateMetaTag('twitter:description', 'Hire the best live singer in Mohali directly with no middleman. PrimeStage offers top-rated singers for weddings, parties, and live events.', true);
           ...
           <div className="bg-gray-50 py-16 px-4">
             <div className="max-w-4xl mx-auto text-center">
               ...
               <h3 className="text-xl md:text-2xl font-medium text-gray-700 mb-6">
                 How to Book a Live Singer in Mohali – Simple & Hassle-Free
               </h3>
               <div className="max-w-3xl mx-auto">
                 <div className="text-gray-600 text-lg leading-relaxed space-y-6">
                   <div className="text-center">
                     <h4 className="text-xl font-bold text-gray-900 mb-2">✨ Choose Your Singer</h4>
                     <p>Browse top live singers in Mohali and pick the perfect match for your event.</p>
                   </div>
       ...
       <div className="max-w-4xl mx-auto text-center">
         ...
         <div className="max-w-3xl mx-auto">
           <p className="text-gray-600 text-lg leading-relaxed">
             Looking to book a live singer in Mohali? Discover handpicked, verified artists who can elevate any event with their live performances.
                           From soulful wedding singers to dynamic performers for corporate events, birthday parties, and private gatherings — our platform connects you with the best live singers in Mohali.
...
export default MohaliSingerSearchResults;
