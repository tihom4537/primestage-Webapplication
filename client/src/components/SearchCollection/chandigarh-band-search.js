...
const ChandigarhBandSearchResults = () => {
 ...
 return (
   <div className="min-h-screen bg-white">
           ...
           <div className="relative w-full h-[450px] overflow-hidden">
             ...
             <div className="absolute inset-0 flex flex-col items-center justify-end bg-black bg-opacity-50 px-4 pb-8 sm:pb-12 md:pb-16">
               ...
               <h2 className="text-xl sm:text-2xl md:text-2xl font-small text-white text-center mb-2">
                 Top-Rated Live Band in Chandigarh for Events
               </h2>
           ...
           <div className="bg-gray-50 py-16 px-4">
             <div className="max-w-4xl mx-auto text-center">
               ...
               <h3 className="text-xl md:text-2xl font-medium text-gray-700 mb-6">
                 How to Book a Live Band in Chandigarh – Simple & Hassle-Free
               </h3>
               <div className="max-w-3xl mx-auto">
                 <div className="text-gray-600 text-lg leading-relaxed space-y-6">
                   <div className="text-center">
                     <h4 className="text-xl font-bold text-gray-900 mb-2">✨ Choose Your Band</h4>
                     <p>Browse top live band in Chandigarh and pick the perfect match for your event.</p>
                   </div>
     ...
     <div className="bg-gray-50 py-16 px-4">
       <div className="max-w-4xl mx-auto text-center">
         <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
           Find Your Perfect Live Band in Chandigarh
         </h2>
         <h3 className="text-xl md:text-2xl font-medium text-gray-700 mb-6">
         ...
         <div className="max-w-3xl mx-auto">
           <p className="text-gray-600 text-lg leading-relaxed">
            Looking to book a live band in Chandigarh? Discover handpicked, verified artists who can elevate any event with their live performances.
             From soulful wedding singers to dynamic performers for corporate events, birthday parties, and private gatherings — our platform connects you with the best live Band in Chandigarh.
...
export default ChandigarhBandSearchResults;
