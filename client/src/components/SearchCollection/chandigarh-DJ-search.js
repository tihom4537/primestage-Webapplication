...
const ChandigarhDJSearchResults = () => {
...
// Update document title and meta tags
    document.title = "Live DJ booking in Chandigarh for Event";
    ...
    // Primary Meta Tags
    updateMetaTag('description', 'Hire the best club DJs in Chandigarh directly with no middleman. PrimeStage offers top-rated DJs for weddings, parties, and live events.');
    updateMetaTag('keywords', 'live, Live DJs, In Chandigarh, Club DJ, chandigarh, booking, artist,DJs, House Party, Event');
    ...
    updateMetaTag('og:title', 'Live DJ booing in Chandigarh', true);
    updateMetaTag('og:description', 'Hire the best live DJ in Chandigarh directly with no middleman. PrimeStage offers top-rated DJs for weddings, parties, and live events.', true);
    updateMetaTag('og:image', '/og-image.jpg', true);


    // Twitter Cards
   updateMetaTag('twitter:card', 'summary_large_image', true);
   updateMetaTag('twitter:title', 'Live DJ booing in Chandigarh', true);
   updateMetaTag('twitter:description', 'Hire the best live DJs in Chandigarh directly with no middleman. PrimeStage offers top-rated DJs for weddings, parties, and live events.', true);
...
<div className="relative w-full h-[450px] overflow-hidden">
 <img
   ...
   alt="Professional DJ setup with turntables and mixer"
    ...
    {/* New Section Above Footer */}
      ...
      {/* New Section Above Footer */}
            <div className="bg-gray-50 py-16 px-4">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  Find Your Perfect Live DJs in Chandigarh
                </h2>
                <h3 className="text-xl md:text-2xl font-medium text-gray-700 mb-6">
                ...
                <div className="max-w-3xl mx-auto">
                  <p className="text-gray-600 text-lg leading-relaxed">
                   Looking to book a live DJs in Chandigarh? Discover handpicked, verified artists who can elevate any event with their live performances.
                    From soulful wedding singers to dynamic performers for corporate events, birthday parties, and private gatherings — our platform connects you with the best live DJs in Chandigarh.
...
export default ChandigarhDJSearchResults;
